...
func (*Timber) Descriptor() ([]byte, []int) {
	return fileDescriptor_timber_b17183e1c3525431, []int{0}
}
...
func (*TimberCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_timber_b17183e1c3525431, []int{1}
}
...
func (*TimberContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_timber_b17183e1c3525431, []int{2}
}
...
func (*ProduceResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_timber_b17183e1c3525431, []int{3}
}
...
func init() { proto.RegisterFile("proto/timber.proto", fileDescriptor_timber_b17183e1c3525431) }

var fileDescriptor_timber_b17183e1c3525431 = []byte{
